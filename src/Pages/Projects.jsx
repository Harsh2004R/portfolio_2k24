                            ...
                            <Box p={{ base: "3", md: "3" }} w="100%" h="100%" bg="#1F1F1F" borderRadius={"2xl"} >
                                <Box w="100%" h={{ base: "20%", md: "15%" }} >
                                    <Flex alignItems={"center"} justifyContent={"space-between"} w="100%" h="100%">
                                        ...
                                        <Link to="projects" smooth={true} duration={500}>   <Text fontSize={{ base: "15px", md: "18px" }} _hover={{ cursor: "pointer", color: "#dadada", transition: "0.3s ease" }} color="#9E9E9E">See All</Text></Link>
